...
const NUMERIC_FIELDS: Record<string, { min: number; max: number }> = {
  ...
  shift_unsubmitted_alert_hour: { min: 0, max: 23 },
  shift_unsubmitted_alert_interval_days: { min: 1, max: 30 },
  shift_unsubmitted_alert_max_repeats: { min: 0, max: 30 },
  shift_variance_alert_threshold_pct: { min: 1, max: 500 },
  shift_variance_alert_min_baseline_hours: { min: 0, max: 200 },
...
const DEFAULT_SETTINGS: Record<string, boolean | number> = {
  ...
  shift_unsubmitted_alert_hour: 9,
  shift_unsubmitted_alert_interval_days: 1,
  shift_unsubmitted_alert_max_repeats: 5,
  shift_variance_alert_threshold_pct: 50,
  shift_variance_alert_min_baseline_hours: 8,
